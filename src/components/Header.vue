<template>
    <header>
        ...
        <a href="/" class="navbar-brand">欢迎来到jack水果直销网站</a>
       <ul class="navbar-nav">
           <li><router-link :to="{name:'homeLink'}" class="nav-link">主页</router-link></li>
           <li><router-link :to="{name:'productLink'}" class="nav-link">商品</router-link></li>
        ...
        <ul class="navbar-nav ml-auto">
           ...
           <li class="nav-link" v-if="currentUser">
               欢迎您,{{currentUser.name}}
           </li>
           <li><router-link :to="{name:'loginLink'}" v-show="isLogin" class="nav-link" >注销</router-link></li>
           <li><router-link :to="{name:'updateLink'}" v-show="isLogin" class="nav-link" >修改信息</router-link></li>
       </ul>
        </nav>
    </header>
</template>
